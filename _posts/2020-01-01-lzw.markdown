...
![Topic B flowchart]({{"/assets/images/Topic B/flowchart.png" | prepend: site.baseurl }})
...
![Topic B dictionary]({{"/assets/images/Topic B/dict.png" | prepend: site.baseurl }}){: style="width:350px; float:left; margin:20px 40px"}
...
![Topic B diagram reference]({{"/assets/images/Topic B/reference.png" | prepend: site.baseurl }}){: style="width:350px; float:right; margin:50px 20px"}
...
![step 1]({{"/assets/images/Topic B/1.png" | prepend: site.baseurl }}){: style="width:200px; float:left; margin:20px 120px"}
...
![step 2]({{"/assets/images/Topic B/2_lookup.png" | prepend: site.baseurl }}){: style="width:400px; float:left; margin:0px 20px"}
...
![step 3]({{"/assets/images/Topic B/2_write.png" | prepend: site.baseurl }}){: style="width:400px; float:left; margin:60px 20px"}
...
![step 4]({{"/assets/images/Topic B/3_lookup.png" | prepend: site.baseurl }}){: style="width:400px; float:left; margin:0px 20px"}
...
![step 5]({{"/assets/images/Topic B/3_write.png" | prepend: site.baseurl }}){: style="width:400px; float:left; margin:60px 20px"}
...
![step 6]({{"/assets/images/Topic B/4.png" | prepend: site.baseurl }}){: style="width:200px; float:left; margin:40px 120px"}
...
![step 7]({{"/assets/images/Topic B/5_lookup.png" | prepend: site.baseurl }}){: style="width:400px; float:left; margin:0px 20px"}
...
![step 8]({{"/assets/images/Topic B/5_write.png" | prepend: site.baseurl }}){: style="width:400px; float:left; margin:80px 20px"}
...
![step 9]({{"/assets/images/Topic B/6_write.png" | prepend: site.baseurl }}){: style="width:400px; float:left; margin:20px 20px"}
